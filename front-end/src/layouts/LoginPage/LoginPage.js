        ...
        <div className="login-page">
            ...
            <section className="login-box">
                ...
                <form className="login-form" onSubmit={handleFormSubmit}>
                    ...
                    <em><p>By logging in you agree to <br />
                        abide by the <a href='https://www.nyu.edu/about/policies-guidelines-compliance/policies-and-guidelines/responsible-use-of-nyu-computers-and-data-policy-on.html' target="_blank" rel="noreferrer">Policy on <br />
                            Responsible Use of NYU <br />
                            Computers and Data.</a></p></em>
